	...
	<div class="row">
      ...
      <div class="col-md-10 personal-info">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input name="semester" class="form-control" readonly required="required" type="text" value="<?php echo $semester ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Email:</label>
            <div class="col-lg-8">
              <input name="email" class="form-control" readonly required="required" type="email" value= "<?php echo $email ?>" >
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Mobile:</label>
            <div class="col-lg-8">
              <input name="mobile" class="form-control" readonly required="required" type="text" value="<?php echo $mobile ?>" >
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Gender:</label>
            <div class="col-lg-8">
              <input name="gender" class="form-control" readonly required="required" type="text" value="<?php echo $gender ?>" >
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-3 control-label">Admission No:</label>
            <div class="col-md-8">
              <input name="regid" class="form-control" readonly required="required" type="text" value= "<?php echo $regid ?>" >
            </div>
          </div>
          <div class="form-group">
