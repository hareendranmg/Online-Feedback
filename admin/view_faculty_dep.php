            ...
            <div class="row content">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-5">
                                <h2>Faculties by Department</h2>
                            </div><br />
                            <div class="col-md-7">
                                <div class="pull-right">
                                    <form class="form-inline" method="get" action="view_faculty_dep.php">
                                        <div class="container-fluid ">
                                            <div class="form-group">
                                                <select name="department_id" class="form-control" required="required">
                                                    <option value="">--Select Department--</option>
                                                    <?php
                                                        $sql = "SELECT department.name, count(*) as count, department.id FROM `faculty` inner join department on faculty.department_id=department.id GROUP by department_id ";
                        ...
                        <table data-vertable="ver6" id="faculties">
                            ...
                            <?php
                                if(isset($_GET['department_id'])) {
                                    $sql = "SELECT * FROM faculty where department_id = ".$_GET['department_id'];
                                    $result = mysqli_query($conn, $sql);
                                    $count = 0;
                                ...
                                ?>
                                    <tr class="row100 data">
                                        ...
                                        <td class="column100 column3" data-column="column3">
                                            <a class="btn btn-block btn-info" href="view_faculty_profile.php?faculty_id=<?php echo $rows['id'] ?>">View Profile</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
